...
import 'package:greendit/features/post/controller/post_controller.dart';
...
class PostCard extends ConsumerWidget {
  ...
  void navigateToComunity(BuildContext context) {
    Routemaster.of(context).push('/g/${post.communityName}');
  }
                          ...
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  GestureDetector(
                                    onTap: () => navigateToComunity(context),
                                    child: CircleAvatar(
