...
class ProfileDrawer extends ConsumerWidget {
  ...
  void logOut(WidgetRef ref) {
    ref.read(authControllerProvider.notifier).loggout();
  }
  ...
  void navigateToCameraView(BuildContext context) {
    Routemaster.of(context).push('/object/');
  }

  void toggleTheme(WidgetRef ref) {
    ref.read(themeNotifierProvider.notifier).toggleThem();
  }
        ...
        child: Column(
          children: [
            ...
            ListTile(
              ...
              onTap: () => navigateToCameraView(context),
            ),
            ListTile(
