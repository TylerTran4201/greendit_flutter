...
import 'package:greendit/features/post/repository/post_repository.dart';
import 'package:greendit/features/user_profile/controller/user_profile_controller.dart';
import 'package:greendit/models/comment.dart';
...
class PostController extends StateNotifier<bool> {
  ...
  void shareImagePost({
    ...
    String postId = const Uuid().v1();
    final user = _ref.read(userProvider)!;
    final imageRes = await _storageRepositoty.storeFile(
